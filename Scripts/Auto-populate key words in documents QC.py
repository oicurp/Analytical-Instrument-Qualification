...
for file_name in os.listdir(absolute_path):
   ...
   # print(type(key_word_in_file_name))
    ...
    for row in list_of_docid:
       if row[9] == key_word_in_file_name:
   ...
   # 1) Iterate through contents
    for p in para:
        for place_holder in list_of_parameter:
            ...
            if place_holder == '{System ID}': para_index = 10
            if place_holder == '{TS ID}': para_index = 7
            if place_holder == '{Dept}': para_index = 11
            if place_holder == '{System Impact}': para_index = 4
            if place_holder == '{System Brand}': para_index = 1
            if place_holder == '{System Model}': para_index = 2
            if place_holder == '{IOQ ID}': para_index = 8
            if place_holder == '{Doc ID}': para_index = 9
            #style = p.style
